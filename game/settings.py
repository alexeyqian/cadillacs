...
PLAYER_HURTBOX_W = 100
PLAYER_HURBOX_H = int(PLAYER_H*0.8)

ENEMY_W=PLAYER_W
ENEMY_H=PLAYER_H
ENEMY_COLLISION_W = PLAYER_COLLISION_W
ENEMY_COLLISION_H = PLAYER_COLLISION_H
# todo: should be percentage of enemy size
ENEMY_HURTBOX_W = PLAYER_HURTBOX_W
ENEMY_HURBOX_H = PLAYER_HURBOX_H
...
ENEMY_SPEED=int(PLAYER_SPEED*0.9)
...
ENEMY_ATTACK_WINDUP=int(ATTACK_1_WINDUP_DURATION*0.8)
ENEMY_ATTACK_ACTIVE=int(ATTACK_1_ACTIVE_DURATION*0.8)
ENEMY_ATTACK_RECOVERY=int(ATTACK_1_RECOVERY_DURATION*0.8)
ENEMY_ATTACK_COOLDOWN=10 # add player attack cooldown?
ENEMY_ATTACK_DAMAGE=int(ATTACK_1_DAMAGE*0.8)

# thinking and make decisions
ENEMY_ATTACK_DELAY=5
