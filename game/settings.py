...
ENEMY_ATTACK_CLASH_RECOVERY=12
ENEMY_ATTACK_CLASH_COOLDOWN=20
...
# melee weapons
FIST_DAMAGE=10
RUNNING_ATTACK_DAMAGE=int(FIST_DAMAGE*1.3)
KNIFE_DAMAGE=int(FIST_DAMAGE*1.5)
BAT_DAMAGE=int(FIST_DAMAGE*2)
THROWN_DAMAGE=int(FIST_DAMAGE*1.5)
######## grab combo ########
PLAYER_GRAB_KNEE_DAMAGE = int(FIST_DAMAGE * 1.2)
PLAYER_GRAB_KNEE_DURATION = 14
PLAYER_GRAB_KNEE_HIT_FRAME = 6
PLAYER_GRAB_KNEE_HITBOX_W = int(PLAYER_W * 0.6)
PLAYER_GRAB_KNEE_HITBOX_H = int(PLAYER_H * 0.45)
# range weapons
