...
def main_draw_ui(game_state):
    ...
    status_text = small_font.render(
        f"CREDITS {game_state.credits} | LIVES {player.lifecycle_state.lives} | NEXT LIFE {game_state.score_manager.next_extra_life_score}",
        True, YELLOW_COLOR)
    ...
    if player.state == player.DEAD and player.lifecycle_state.lives <= 0:
